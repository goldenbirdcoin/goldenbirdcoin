...
static const int LAST_POW_BLOCK = 1000000; // at 60 second blocks will be about 100 years from launch
...
static const uint256 hashGenesisBlock("0x00000ed8c3d75dca0c8cd56766be348d4d36a47fe2934e89f817caddfa4ad2dc");
...
public:
    ...
    {
        // GoldenBird: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // GoldenBird: get transaction coin age
...
public:
    ...
    // GoldenBird: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // GoldenBird: two types of block: proof-of-work or proof-of-stake
    ...
    // GoldenBird: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // GoldenBird: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // GoldenBird: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // GoldenBird: block index flags
    enum  
    {
